...
export default function PortfolioRebalance() {
  ...
  return (
    <ProductionPageTemplate
      ...
      breadcrumbs={[
        { label: 'Home', href: '/' },
        { label: 'PortfolioRebalance', href: '/portfoliorebalance' }
      ]}
      actions={
      ...
      <Suspense fallback={<SkeletonCard />}>
        <div className="space-y-6">
          <Card className="p-6 border-slate-800 hover:border-pink-500/50 transition-colors">
            <h2 className="text-2xl font-bold mb-4 text-white">PortfolioRebalance</h2>
            <p className="text-slate-400 mb-4">
              Enterprise-grade portfoliorebalance page with production-ready components,
