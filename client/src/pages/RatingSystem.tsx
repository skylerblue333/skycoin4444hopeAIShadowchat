...
export default function RatingSystem() {
  ...
  return (
    <ProductionPageTemplate
      ...
      breadcrumbs={[
        { label: 'Home', href: '/' },
        { label: 'RatingSystem', href: '/ratingsystem' }
      ]}
      actions={
      ...
      <Suspense fallback={<SkeletonCard />}>
        <div className="space-y-6">
          <Card className="p-6 border-slate-800 hover:border-pink-500/50 transition-colors">
            <h2 className="text-2xl font-bold mb-4 text-white">RatingSystem</h2>
            <p className="text-slate-400 mb-4">
              Enterprise-grade ratingsystem page with production-ready components,
